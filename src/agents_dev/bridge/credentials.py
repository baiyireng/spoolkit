...
# 每个通道认哪些名字（前者是文档里的规范名）。
QQ_APP_ID = ("AGENTS_DEV_QQ_APPID", "QQ_AppID", "QQ_APPID")
QQ_SECRET = ("AGENTS_DEV_QQ_SECRET", "QQ_AppSecret", "QQ_SECRET")
TELEGRAM_TOKEN = ("AGENTS_DEV_TELEGRAM_TOKEN", "TELEGRAM_BOT_TOKEN", "TELEGRAM_TOKEN")
WECOM_CORP_ID = ("AGENTS_DEV_WECOM_CORP_ID", "WECOM_CORP_ID")
WECOM_SECRET = ("AGENTS_DEV_WECOM_SECRET", "WECOM_SECRET")
WECOM_AGENT_ID = ("AGENTS_DEV_WECOM_AGENT_ID", "WECOM_AGENT_ID")
