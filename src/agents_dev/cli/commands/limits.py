...
```
agents-dev limits                       # 现在生效的是多少、从哪来
agents-dev limits --set repeat_block_at=5
agents-dev limits --reset repeat_block_at
```
    ...
    if args.set:
        ...
        for item in args.set:
            ...
            if entry is None:
                ...
                print("用 `agents-dev limits` 看全部名字。", file=sys.stderr)
                return 2
